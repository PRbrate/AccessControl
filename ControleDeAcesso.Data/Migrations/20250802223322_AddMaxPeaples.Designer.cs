...
namespace AccessControl.Data.Migrations
{
    ...
    [Migration("20250802223322_AddMaxPeaples")]
    partial class AddMaxPeaples
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccessControl.Domain.Entites.User", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("ContaId"));
            ...
            modelBuilder.Entity("EventDomainUserEvent", b =>
                {
                    b.Property<Guid>("EventsId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("UsersEventId")
                        .HasColumnType("uuid");

                    b.HasKey("EventsId", "UsersEventId");

                    b.HasIndex("UsersEventId");
            ...
            modelBuilder.Entity("EventDomainUserEvent", b =>
                {
                    b.HasOne("ControleDeAcesso.Domain.Entites.EventDomain", null)
                        .WithMany()
                        .HasForeignKey("EventsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ControleDeAcesso.Domain.Entites.UserEvent", null)
                        .WithMany()
                        .HasForeignKey("UsersEventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
